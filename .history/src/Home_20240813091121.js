...
function Home() {
  ...
  const defaultUrl = `https://api.edamam.com/search?q=Breakfast&app_id=${APP_ID}&app_key=${APP_KEY}&from=0&to=8`; 
  ...
  return (
    <div className='container'>
      ...
      <div className='head'><h2 onClick={getData}>Discover Your Perfect Meal</h2></div>
